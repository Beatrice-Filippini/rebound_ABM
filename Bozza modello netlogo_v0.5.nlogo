...
create-users n-users[
  ...
  create-companies n-companies [
    ...
    set target-price product-price
...
to price-demand-regulation
  ask companies[
    ...
    if ticks >= price-period [
      ...
      ifelse (product-price  >= target-price * 0.5) [
  ...
  ask companies[
    ...
    if ticks >= sust-period [
        ...
        if(product-sustainability * 1.1 <= 1) [
          set product-sustainability product-sustainability * 1.01  ;increase sustainability of the product of 10%
