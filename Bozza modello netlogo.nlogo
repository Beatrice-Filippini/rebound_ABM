...
=======
;v0.5
  set threshold-1 (1 / 3)*shelf-life  ;here i can set it differently for the food vs fashion sector
  set threshold-2 (2 / 3)*shelf-life
...
to utility-function-management
  ...
  ask users [
    ...
    set best-company max-one-of companies [p-quality-norm * my-alpha + p-sustainability-norm * my-beta - p-price-norm * my-gamma - p-acceptance-norm * my-delta]
    set utility ([p-quality-norm] of best-company * my-alpha) + ([ p-sustainability-norm ] of best-company * my-beta) - ([ p-price-norm ] of best-company * my-gamma) - ([p-acceptance-norm] of best-company * my-delta)
...
to discount
  ask companies[
<<<<<<< HEAD
    if (ticks = threshold-1 )
    [  set p-price p-price * 0.9   ;FIX
       set p-quality p-quality * 0.9 ;FFIX
=======
    if ticks threshold-1 [
      p-price p-price * 0.9 ;fix
    p-quality p-quality * 0.9
>>>>>>> 193fe54922fadc0dc0784e42e6d12239bd87f0bb
    ]
  ]
end
