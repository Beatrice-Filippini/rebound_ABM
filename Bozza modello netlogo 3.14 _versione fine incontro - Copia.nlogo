...
to read-file-matrix
    file-close-all
    set file-name-m1 "Reprocessing_matrix.csv"
...
to creation-companies
  ...
  ask companies [
    ...
    set c-security-stock map [t -> t * 100] p-cons-per-user-list                              ;the company's security stock of class i products, is proportional to the consumption rate of class i
    while [ i < n-class-of-products ] [
...
"pen-1" 1.0 0 -8630108 true "" "plot count (users with [buy-bool = true]) / n-users"
...
"avg-prod-sust" 1.0 0 -1184463 true "" "plot mean [p-sustainability] of products"
"reprocessed-prod-sust" 1.0 2 -14439633 true "" "ifelse (any? products with [primary-prod = 0])\n[ plot mean [p-sustainability] of (products with [primary-prod = 0]) ]\n[ plot 0 ]"
"pen-3" 1.0 0 -7500403 true "" "ifelse (length chosen-prod-sust-list = 0)\n[plot 0]\n[plot mean chosen-prod-sust-list]"
...
- controllare che c-quality sia implementato correttamente ovunque
